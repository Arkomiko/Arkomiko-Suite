...
if (enableGUI) {
  ...
  f1.add(ui, "hueRange", 0, 140).onChange(ui.change);

  f2.add(ui, "particleCount", 300, 10000).step(100).onChange(ui.reset);
  f2.add(ui, "particleSize", 0.001, 3).onChange(ui.change);
  f2.add(ui, "trailLength", 0.005, 1.5).onChange(ui.bgColor);
  f2.add(ui, "maxSpeed", 0.5, 5.0).onChange(ui.change);

  f3.add(ui, "fieldSize", 10, 350).step(1).onChange(ui.change);
  f3.add(ui, "fieldForce", 0.05, 1).onChange(ui.change);
  f3.add(ui, "noiseSpeed", 0.001, 1.105).onChange(ui.change);
